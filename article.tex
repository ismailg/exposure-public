...
and behaviors. The \emph{corrective experience hypothesis}, rooted in attachment
...
\emph{resistant} to such corrective experiences. RS is characterized by stable
negative expectations that operate through self-fulfilling prophecies
(Downey \& Feldman, 1996)---high RS individuals interpret ambiguous social
...
schemas resist modification despite contradictory evidence (Kube et al., 2020).
...
\subsubsection{Exploitation diagnostic}\label{exploitation-diagnostic}
...
\bibitem[\citeproctext]{ref-thielmann_personality_2020}
