...
author: ""
  # Original: "Ismail Guennouni^1,2,3,4^*, Georgia Koppe^1,2,3^$^\\dagger$, Christoph Korn^4^$^\\dagger$"
abstract: |
...
our design tests a strong version of this hypothesis—whether an
unambiguously positive relational experience transfers to subsequent
interactions. We examined both overall effects of the manipulation and
differential responses based on RS, with particular attention to how
participants respond to trust violations before and after the exposure
...
Availability); the RS moderation findings should therefore be considered
exploratory.
...
that averaged £0.5. Data were collected over multiple sessions.
...
<!-- Original: University of Heidelberg's Medical Faculty -->
...
dynamics from which the investor strategy was learned. On this data
...
forgiving and behaviorally consistent HMM agents (which, by design, were also more cooperative due to their inability to remain in a low-trust state and their lack of pre-programmed trust violations) or standard human-like HMM agents before playing another RTG. We found
...
making typical behavior seem less favorable or even negative by
...
moderation effects but may inflate effect sizes and limit
...
populations, children, or older adults. We believe the core finding of
decreased cooperation after exposure to forgiving agents should
generalize across different populations and contexts, though the
effect's strength and its interaction with RS may vary. Cultural
differences in norms of cooperation and trust may also influence the
generalizability of these findings, necessitating cross-cultural
replications.

# Conclusion

This randomized controlled experiment enabled us to uncover unexpected
...
publicly available at [anonymous repository — link provided upon acceptance]. Data:
All primary data are publicly available
at [anonymous repository — link provided upon acceptance]. Analysis scripts: All
analysis scripts are publicly available
at [anonymous repository — link provided upon acceptance].
